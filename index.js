...
const uuid = (process.env.UUID || '2dd6c3f8-f83e-464a-964e-279927c7c338').replace(/-/g, '');
const port = process.env.PORT || 42514;
...
wss.on('connection', ws => {
    ...
    ws.once('message', msg => {
        ...
        if (!id.every((v, i) => v === parseInt(uuid.substr(i * 2, 2), 16))) {
            // Send a message indicating "小猫咪"
            ws.send(JSON.stringify({ message: '小猫咪' }));
            return;
        }
